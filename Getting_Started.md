...
interface](Web_Interface.md "wikilink") which can also be used locally or
remotely.

There is more than one type of DFN observatory; you can figure out what
type you have [here](Observatory_Types.md "wikilink"). Most of the
instructions on this wiki will focus primarily on the latest
[DFNEXT](DFNEXT.md "wikilink") observatories as more of these have been
...
install them in the [DFNEXT](Observatory_Types.md "wikilink") box upon
arrival.

Please follow
[these](How_to_install_flanged_Samyang_lens_and_DSLR_to_the_DFNEXT_enclosure.md "wikilink")
instructions: [How to install flanged Samyang lens and DSLR to the
DFNEXT
enclosure](How_to_install_flanged_Samyang_lens_and_DSLR_to_the_DFNEXT_enclosure.md "wikilink")
...
- [locally via the network (ethernet or
  WiFi)](Logging_in_locally_via_WiFi_or_Ethernet.md "wikilink")
  (**recommended initially**)
- [locally using a HDMI or VGA monitor and USB
  keyboard](Manual_Maintenance#Direct_connection.md "wikilink")
- [remotely over the
...
interface](Web_Interface.md "wikilink") for all three of the above
...
[Windows Shell](wikipedia:Windows_shell.md "wikilink") or [Mac OS X
...
interface](Web_Interface.md "wikilink"). This interface is useful for users
...
- [Setting up an SSH key](SSH_Keys.md "wikilink") for the terminal
  connection
- [Editing your hosts file](Hosts_File.md "wikilink")

We currently have three different fireball observatory designs; see
[Which camera](Which_camera.md "wikilink") do I have?
...
- **Roof versus ground setup**: a [roof
  setup](Rooftop_Fireball_Camera_Installation.md "wikilink") seems easy and
  convenient, but can actually take more time to set up than a [ground
  setup](Standalone_Fireball_Camera_Installation.md "wikilink") and
...
toolkit](Camera_Maintenance_Toolkit.md "wikilink"). This is a
[comprehensive servicing](Camera_servicing_kit.md "wikilink") kit we use on
field trips in Australia.

[Servicing and deployment
checklists](Camera_Maintenance#Servicing_and_deployment_checklists.md "wikilink") -
printable PDF sheets to go through on the remote site

[Rooftop Fireball Camera
Installation](Rooftop_Fireball_Camera_Installation.md "wikilink") (valid
for DFNSMALL and DFNEXT)

[Standalone Fireball Camera
Installation](Standalone_Fireball_Camera_Installation.md "wikilink")

[Rooftop Kit Camera
Installation](Rooftop_Kit_Camera_Installation.md "wikilink") (if your
...
[Configuring the Software](Configuring_the_Software.md "wikilink")

[Calibrating the camera
orientation](Calibrating_the_camera_orientation.md "wikilink")

[Creating a Mask](Creating_a_Mask.md "wikilink") to remove non-sky regions
of the image

#### Internet access

[Finding network interface MAC
address](Finding_network_interface_MAC_address.md "wikilink")

[Mobile network - 3G, 4G](Mobile_network_-_3G,_4G.md "wikilink")

[WiFi configuration](WiFi_configuration.md "wikilink")
