...
interface](Web_Interface "wikilink") which can also be used locally or
remotely.

There is more than one type of DFN observatory; you can figure out what
type you have [here](Observatory_Types "wikilink"). Most of the
instructions on this wiki will focus primarily on the latest
[DFNEXT](DFNEXT "wikilink") observatories as more of these have been
...
install them in the [DFNEXT](Observatory_Types "wikilink") box upon
arrival.

Please follow
[these](How_to_install_flanged_Samyang_lens_and_DSLR_to_the_DFNEXT_enclosure "wikilink")
instructions: [How to install flanged Samyang lens and DSLR to the
DFNEXT
enclosure](How_to_install_flanged_Samyang_lens_and_DSLR_to_the_DFNEXT_enclosure "wikilink")
...
- [locally via the network (ethernet or
  WiFi)](Logging_in_locally_via_WiFi_or_Ethernet "wikilink")
  (**recommended initially**)
- [locally using a HDMI or VGA monitor and USB
  keyboard](Manual_Maintenance#Direct_connection "wikilink")
- [remotely over the
  VPN](Logging_in_remotely_over_the_network "wikilink")

You have the choice of either using the terminal or the graphical [web
interface](Web_Interface "wikilink") for all three of the above
...
[Windows Shell](wikipedia:Windows_shell "wikilink") or [Mac OS X
...
interface](Web_Interface "wikilink"). This interface is useful for users
...
- [Setting up an SSH key](SSH_Keys "wikilink") for the terminal
  connection
- [Editing your hosts file](Hosts_File "wikilink")

We currently have three different fireball observatory designs; see
[Which camera](Which_camera "wikilink") do I have?
...
Software](Configuring_the_Software "wikilink"))
...
- **Roof versus ground setup**: a [roof
  setup](Rooftop_Fireball_Camera_Installation "wikilink") seems easy and
  convenient, but can actually take more time to set up than a [ground
  setup](Standalone_Fireball_Camera_Installation "wikilink") and
...
toolkit](Camera_Maintenance_Toolkit "wikilink"). This is a
[comprehensive servicing](Camera_servicing_kit "wikilink") kit we use on
field trips in Australia.

[Servicing and deployment
checklists](Camera_Maintenance#Servicing_and_deployment_checklists "wikilink") -
printable PDF sheets to go through on the remote site

[Rooftop Fireball Camera
Installation](Rooftop_Fireball_Camera_Installation "wikilink") (valid
for DFNSMALL and DFNEXT)

[Standalone Fireball Camera
Installation](Standalone_Fireball_Camera_Installation "wikilink")

[Rooftop Kit Camera
Installation](Rooftop_Kit_Camera_Installation "wikilink") (if your
...
[Configuring the Software](Configuring_the_Software "wikilink")

[Calibrating the camera
orientation](Calibrating_the_camera_orientation "wikilink")

[Creating a Mask](Creating_a_Mask "wikilink") to remove non-sky regions
of the image

#### Internet access

[Finding network interface MAC
address](Finding_network_interface_MAC_address "wikilink")

[Mobile network - 3G, 4G](Mobile_network_-_3G,_4G "wikilink")

[WiFi configuration](WiFi_configuration "wikilink")
