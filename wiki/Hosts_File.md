An [IP address](wikipedia:IP_address "wikilink") is the address of your
observatory on the DFN's network of computers and observatories. The
[VPN](Logging_in_remotely_over_the_network "wikilink") is used to
...
Types](Observatory_Types "wikilink")).
