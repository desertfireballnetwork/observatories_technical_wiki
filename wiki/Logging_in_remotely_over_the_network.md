...
[here](How_VPN_works "wikilink") you can find very brief and condensed
...
us. Contact [DFN camera help](Getting_Help "wikilink") and we will
...
help](Getting_Help "wikilink") by following the instructions
...
need to use the [VPN IP address](IP_Addresses "wikilink") of the camera
...
for convenience](Hosts_File "wikilink") you would into DFNEXT17 by
running the command:

`ssh root@DFNEXT17`

If you have not set up your local [hosts file](Hosts_File "wikilink"),
you would run the command:

`ssh root@10.1.23.17`

You will then be prompted to [unlock your SSH key to log
in](SSH_Keys "wikilink") or enter the root user password if you aren't
using an SSH key.
...
from
Windows](Logging_in_locally_via_WiFi_or_Ethernet#Logging_in_via_the_Terminal_from_Windows "wikilink").
You will need to use the relevant [VPN IP
address](IP_Addresses "wikilink") instead of the local addresses though.

# Logging in via the Web Interface

If you have [set up your hosts file](Hosts_File "wikilink"), you can now
...
convenience](Hosts_File "wikilink") then you will need to look up your
observatories [VPN IP address](IP_Addresses "wikilink") and enter that
